...
public class Player : NetworkBehaviour, IKitchenObjectParent {
    ...
    private void Update() {
        ...
        //HandleMovementServerAuth(); //for this i need to change the client network transform component in player object to make it network transform
        HandleMovement();
        HandleInteractions();
    }
    ...
    private void SetSelectedCounter(BaseCounter selectedCounter) {
        ...
        Debug.Log("Selected Counter : " + this.selectedCounter);
